...
get_template_part('/inc/agency-options');
...
function agency_setup_theme(){
    ...
    register_nav_menus(array(
        'main-menu' => __('Primary Menu', 'agency')
    ));
}
add_action('after_setup_theme', 'agency_setup_theme');

function agency_css_js_enqueue(){
...
add_action('wp_enqueue_scripts','agency_css_js_enqueue');
...
function agency_custom_posts(){
   ...
   // Team Custom Post
    ...
    register_post_type('portfolio', array(
        'labels' => array(
            'name' => __('Portfolios', 'agency'),
            'singular_name' => __('Portfolio', 'agency')
        ),
        'public' => true,
        'supports' => array('title', 'editor', 'thumbnail', 'custom-field', 'page-attributes')
    ));
    ...
    register_taxonomy('portfolio-cat', 'portfolio',array(
        'labels' => array(
            'name' => __('Categories', 'agency'),
            'singular_name' => __('Category', 'agency')
        ),
        'hierarchical' => true,
...
function agency_widgets(){
    ...
    register_sidebar(array(
        'name' => __('Main Sidebar','agency'),
        'id' => 'main_sidebar',
        'description' => __('Main Sidebar for Blog Page', 'agency'),
    ...
    // Footer Sidebar 1
    register_sidebar(array(
        'name' => __('Footer Sidebar 1','agency'),
        'id' => 'footer_sidebar1',
        'description' => __('Footer Widget 1 for Showing Widget', 'agency'),
    ...
    // Footer Sidebar 2
    register_sidebar(array(
        'name' => __('Footer Sidebar 2','agency'),
        'id' => 'footer_sidebar2',
        'description' => __('Footer Widget 2 for Showing Widget', 'agency'),
    ...
    // Footer Sidebar 3
    register_sidebar(array(
        'name' => __('Footer Sidebar 3','agency'),
        'id' => 'footer_sidebar3',
        'description' => __('Footer Widget 3 for Showing Widget', 'agency'),
        'before_widget' => '<div class="single-footer">',
        'after_widget' => '</div>',
        'before_title' => '<h4>',
        'after_title' => '</h4>'
    ...
    // Footer Sidebar 4
    register_sidebar(array(
        'name' => __('Footer Sidebar 4','agency'),
        'id' => 'footer_sidebar4',
        'description' => __('Footer Widget 4 for Showing Widget', 'agency'),
...
add_action('widgets_init', 'agency_widgets');


//Comment fields Order

function agency_comment_filed( $fields ) {
...
add_filter( 'comment_form_fields', 'agency_comment_filed' );

require_once get_template_directory().'/inc/agency-activation.php';
